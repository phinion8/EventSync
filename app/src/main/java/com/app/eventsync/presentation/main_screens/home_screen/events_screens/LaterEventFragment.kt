...
import com.app.eventsync.databinding.FragmentLaterEventBinding
...
@AndroidEntryPoint
class LaterEventFragment : Fragment(), EventItemListener {

    private lateinit var binding: FragmentLaterEventBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentLaterEventBinding.inflate(layoutInflater)
        ...
        viewModel.getLaterDataList().observe(viewLifecycleOwner){ value->
            ...
            when(value){
                ...
                is DatabaseState.Success->{
                    viewModel.setLaterEventListSize(value.data!!.size)
