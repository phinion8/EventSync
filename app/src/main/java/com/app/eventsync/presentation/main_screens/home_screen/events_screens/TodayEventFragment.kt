...
import com.app.eventsync.databinding.FragmentTodayEventBinding
...
@AndroidEntryPoint
class TodayEventFragment : Fragment(), EventItemListener {
    ...
    override fun onCreateView(
        ...
        binding = FragmentTodayEventBinding.inflate(layoutInflater)
        adapter = EventsListAdapter(requireContext(), this)

        viewModel.getTodayDataList().observe(viewLifecycleOwner) { value ->
            ...
            when (value) {
                ...
                is DatabaseState.Success -> {
                    viewModel.setTodayEventListSize(value.data!!.size)
        ...
        binding.rvEvent.addOnScrollListener(object : OnScrollListener() {
...
interface EventItemListener {
    fun onEventEnrollButtonClick(eventId: String, eventTitle: String, eventTime: Date)
    fun onEventItemClick(eventItem: Event)
    fun onEventEditButtonClick(eventId: String)
}
