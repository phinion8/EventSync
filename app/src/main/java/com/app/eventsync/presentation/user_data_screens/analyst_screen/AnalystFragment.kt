package com.app.eventsync.presentation.user_data_screens.analyst_screen
...
import com.app.eventsync.databinding.FragmentAnalystBinding
...
import com.app.eventsync.presentation.user_data_screens.viewModels.AnalystViewModel
...
@AndroidEntryPoint
class AnalystFragment : Fragment(), EventItemListener {

    private lateinit var binding: FragmentAnalystBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentAnalystBinding.inflate(layoutInflater)
        adapter = EventsListAdapter(requireContext(),this, true)
        ...
        viewModel.getEventListFromDate(year, month, day)

        viewModel.eventListState.observe(viewLifecycleOwner) { value ->
            when (value) {
                ...
                is DatabaseState.Success -> {
                    binding.tvEventsOnThisDate.text = "Events on this date(${value.data!!.size})"
                    adapter.updateEvents(value.data)
                    checkForNoData()
